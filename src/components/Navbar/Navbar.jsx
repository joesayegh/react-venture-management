...
const Navbar = () => {
	...
	const toggleNav = () => {
		document.querySelector(".navicon").classList.toggle("fixed");
		document.querySelector(".primary-nav-wrapper").classList.toggle("open");
		...
		<header>
			<div className="container padding">
				<div className="header-nav-wrapper">
					<div className="logo">
						<Link to="/">
							<span className="wai">Venture Management</span>
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 187.939 43.674">
								<g id="LOGO">
									<g id="TEXT">
										<g>
					...
					<div className="navicon">
						<button type="button" onClick={toggleNav} className={isActive ? "nav-toggle active" : "nav-toggle"}>
